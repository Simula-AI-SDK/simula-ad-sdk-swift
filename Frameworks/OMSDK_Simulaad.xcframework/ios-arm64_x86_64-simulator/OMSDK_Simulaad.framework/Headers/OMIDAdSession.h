 ...
 */
@interface OMIDSimulaadAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDSimulaadAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDSimulaadAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDSimulaadAdSessionContext *)context
