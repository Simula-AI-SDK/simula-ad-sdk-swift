 ...
 */
@interface OMIDSimulaadAdEvents : NSObject
 ...
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDSimulaadAdSession *)session error:(NSError * _Nullable * _Nullable)error;
 ...
 */
- (BOOL)loadedWithVastProperties:(OMIDSimulaadVASTProperties *_Nonnull)vastProperties
