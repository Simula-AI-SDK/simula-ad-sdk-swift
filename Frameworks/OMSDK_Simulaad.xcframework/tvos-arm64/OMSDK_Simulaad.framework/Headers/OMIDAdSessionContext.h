 ...
 */
@interface OMIDSimulaadAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDSimulaadPartner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDSimulaadPartner *)partner
                               ...
                               resources:(NSArray<OMIDSimulaadVerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
...
- (nullable instancetype)initWithPartner:(OMIDSimulaadPartner *)partner
                              ...
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                           universalAdID:(nullable OMIDSimulaadUniversalAdID *)universalAdID
                                   error:(NSError *_Nullable *_Nullable)error;
